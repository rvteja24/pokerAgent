# Agent reference taken from https://github.com/ishikota/PyPokerEngine/tree/master/examples/players
# and modified for 6 player setting for testing our agent
...
class HonestPlayer(BasePokerPlayer):
    ...
    def declare_action(self, valid_actions, hole_card, round_state):
        ...
        win_rate = estimate_win_rate(10400, self.num_players, hole_card, round_state['community_card'])
